            ...
            <div className="lg:col-span-2">
              <Reveal direction="left">
                <div className="lg:sticky lg:top-24">
                  <span className="text-blue text-xs font-mono uppercase tracking-widest block mb-2 sm:mb-3">
                    Software Division
                  </span>
                  ...
                  <div className="space-y-2.5 sm:space-y-3 mb-6 sm:mb-8">
                    {[
                      ...
                      <div key={f} className="flex items-center gap-2.5 sm:gap-3">
                        <CheckCircle size={15} weight="fill" className="text-blue flex-shrink-0" />
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-4 sm:px-5 py-2.5 bg-blue text-white text-sm font-semibold rounded-md hover:bg-blue-light active:scale-[0.98] transition-all"
                  >
                    Visit phinova.dev
