...
export default function NotFound() {
  return (
    <div className="min-h-[100dvh] flex flex-col items-center justify-center bg-ink px-6 text-center">
      <AkofenaIcon size={48} color="rgba(201,147,58,0.4)" className="mb-8" />
      ...
      <Link
        href="/"
        className="inline-flex items-center gap-2 px-5 py-2.5 bg-gold text-ink text-sm font-semibold rounded-sm hover:bg-gold-light active:scale-[0.98] transition-all"
      >
        Go home
      </Link>
    </div>
